...
static bool game_capture_audio_mix(void *data, uint64_t *ts_out,
				   ...
				   size_t channels, size_t sample_rate)
{
	...
	return render_child_audio(gc->audio_source, ts_out, audio_output,
				  channels);
}
...
struct obs_source_info game_capture_info = {
	...
	.output_flags = OBS_SOURCE_VIDEO | OBS_SOURCE_AUDIO |
			OBS_SOURCE_SUBMIX | OBS_SOURCE_CUSTOM_DRAW |
	...
	.audio_mix = game_capture_audio_mix,
