...
/*
 * Fake encoders for pre-31.0 encoder compatibility.
 *
			   ...
			   obs_encoder_t *encoder, bool texture)
{
	...
	case CODEC_H264:
		return obs_encoder_create_rerouted(
			encoder, texture ? "obs_nvenc_h264_tex_v2"
					 : "obs_nvenc_h264_cuda_v2");
	case CODEC_HEVC:
		return obs_encoder_create_rerouted(
			encoder, texture ? "obs_nvenc_hevc_tex_v2"
					 : "obs_nvenc_hevc_cuda_v2");
	case CODEC_AV1:
		return obs_encoder_create_rerouted(
			encoder, texture ? "obs_nvenc_av1_tex_v2"
