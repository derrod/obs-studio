...
def find_people_to_blame(raw_services: str, servers: list) -> list:
    ...
    # Yeah this is silly, but the file is only ~2600 lines so this isn't too crazy
    line_author = dict()
...
def main():
    ...
    if removed_something:
        ...
        msg = PR_MESSAGE.format(repository=os.environ['REPOSITORY'], run_id=os.environ['WORKFLOW_RUN_ID'],
                                authors=', '.join(f'{author}' for author in authors))  # todo add an "@"
